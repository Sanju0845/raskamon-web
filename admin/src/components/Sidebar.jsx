...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        ref={sidebarRef}
        className={`min-h-fit sm:min-h-screen bg-white rounded-r-md sm:rounded-none sm:border-r md:block fixed md:static min-w-64 z-40 transition-transform duration-300 ease-in-out ${isMenuOpen ? "translate-x-0" : "-translate-x-full sm:translate-x-0"
          }`}
      >
        {/* admin panel sidebar */}
        {aToken && (

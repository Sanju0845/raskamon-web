...
import { ArrowRight, ChevronDown, Menu, X, Heart, Coins } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            {token && (
              ...
              >
                <div className="flex items-center space-x-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 py-1.5 rounded-full">
                      ...
                      >
                        <div className="p-2">
                          ...
                          <motion.div
                            ...
                            className="flex items-center justify-between px-3 py-3 sm:py-2.5 rounded-xl cursor-pointer transition-all duration-200 touch-manipulation"
                          >

...
const Doctors = () => {
  ...
  // Check credits before booking
  const handleAppointmentBooking = async (doctorId) => {
    // Removed credits check - allow booking directly
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            >
              ...
              <span className="text-purple-700 font-medium">Find Your Mental Health Expert</span>
              <div className="ml-4">
                <CreditsDisplay />
              </div>
            </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-1/4">
            ...
            >
              <button
                className={`w-full py-4 px-6 flex items-center justify-between gap-2 rounded-2xl text-lg font-semibold transition-all duration-300 lg:hidden ${showFilter
                  ...
                  <div className="space-y-4">
                    {specialities.map((spec, index) => (
                      <motion.button
                        ...
                        className={`w-full text-left px-6 py-4 rounded-2xl transition-all flex items-center gap-4 ${speciality === spec
                      ...
                      >
                        <div
                          className={`w-3 h-3 rounded-full ${speciality === spec ? "bg-white" : "bg-purple-500"
                            }`}
                        ></div>
                ...
                {doctors?.map((doctor, index) => (
                  ...
                  >
                    ...
                    <div className="relative h-64 overflow-hidden">
                      ...
                      />
                      <div
                        className={`absolute top-4 right-4 px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2 backdrop-blur-sm ${doctor.available
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="space-y-3 mb-6">
                        <div className="flex items-center  text-gray-600">
                          ...
                          />
                          <span className="truncate text-sm mr-3">
                            {doctor.address?.line1 || "Online & In-person"}
                          </span>
                          {doctor?.distanceInKm && (
                            <span>{doctor.distanceInKm.toFixed(1)} km</span>
                          )}
                        </div>
                        <div className="flex items-center text-gray-600">
                          <Briefcase

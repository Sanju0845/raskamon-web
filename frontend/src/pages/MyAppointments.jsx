                          ...
                          <div className="flex-1">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                              ...
                              <div className="space-y-4">
                                ...
                                {/* Prescription & Medication from Doctor */}
                                {item.uploadedReports && item.uploadedReports.length > 0 && item.uploadedReports.some(report => report.fileUrl || report.medication) && (
                                  <div className="bg-indigo-50 rounded-xl p-4 border border-indigo-100">
                                    ...
                                    <div className="space-y-3">
                                      {item.uploadedReports.map((report, idx) => (
                                        <div key={idx} className="bg-white rounded-lg p-3 border border-indigo-200">
                                          {/* Prescription Image/PDF - Download only */}
                                          {report.fileUrl && (
                                            <div className="mb-2">
                                              <p className="text-sm text-gray-600 mb-1">Prescription:</p>
                                              <a
                                                href={report.fileUrl?.startsWith("http") ? report.fileUrl : `${import.meta.env.VITE_BACKEND_URL}${report.fileUrl}`}
                                                target="_blank"
                                              ...
                                              >
                                                <FaFileMedical />
                                                {report.fileType === "application/pdf" || report.filename?.endsWith(".pdf")
                                                  ? "Download PDF"
                                          ...
                                          {report.medication && (
                                            <div>
                                              ...
                                              <p className="text-gray-700 bg-gray-50 p-2 rounded-lg text-sm whitespace-pre-wrap">
                                                {report.medication}
                                              </p>
                                            </div>
                                          )}
                            ...
                            <div className="flex flex-col gap-3 w-full max-w-xs">
                              ...
                              {!item.cancelled && !item.isCompleted && (
                                <motion.button
                                  ...
                                  className={`text-sm text-center w-full px-4 py-3 rounded-xl transition-all duration-200 ease-in-out font-semibold ${loadingCancel[item._id]

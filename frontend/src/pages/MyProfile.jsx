...
import CreditsPurchaseModal from "../components/CreditsPurchaseModal.jsx";
    ...
    userData && (
      ...
      >
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-lg font-semibold text-[#7c3aed]">Credits Balance</h3>
                    <CreditsDisplay />
                  </div>
                  <button
                    onClick={() => setShowCreditsModal(true)}
                    className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all"
                  >
        ...
        <CreditsPurchaseModal
          ...
          onPurchaseSuccess={loadUserProfileData}
        />
      </div>
    )
  );
